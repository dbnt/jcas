...
/**
 * A FullPattern is a Pattern composed of one bitmask for each reel.
 * 
 * @version 1.1
 * @author James Echmalian, ech@ech.net
 */
public class FullPattern extends Pattern
{
	private int[] masks;
	...
	public String toString ()
	{
		...
		for (int i = 0; i < masks.length; ++i)
		{
			if (i > 0)
				buf.append (" ");
			buf.append ("0x");
			buf.append (Integer.toString (masks[i], 16));
		}
